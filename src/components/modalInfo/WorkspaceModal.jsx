        ...
        <div className="workspace-modal w-10/12 sm:w-8/12 md:w-10/12 " id="sidebarOverflow">
          ...
          <div className="md:flex md:flex-row-reverse child-overflow ">
            <div className="md:w-2/4 flex content-center items-center px-4">
              <img
                src="https://img.freepik.com/free-vector/share-link-concept-illustration_114360-5518.jpg?w=740&t=st=1661382082~exp=1661382682~hmac=04713fddbf21f2a49b1870dff6fb2a421a5e1ddccd02183d5bb56cf270122f5a"
                alt="illustration"
              />
            </div>
              ...
              >
                ...
                <div className="form-control w-full max-w-xs mb-4">
                  ...
                  <input
                    ...
                    className="input input-bordered w-full max-w-xs modalWorkspace"
                  />
                  {nameError}
                  <label className="label">
