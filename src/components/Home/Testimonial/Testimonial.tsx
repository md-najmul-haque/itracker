  ...
  return (
    ...
    <div className='pt-14  px-10 dark:bg-black'>
      <div className="w-full lg:w-2/5 mx-auto ">
        <h1 className="text-5xl font-bold text-center dark:text-white mb-20 lg:mb-0 py-4">
          Our Client’s Speak
        </h1>
      </div>
      <div className="" >
        ...
        >
          ...
          <div className=" ">
            <div className="card card-compact w-72 h-96 shadow-xl flex py-10 items-center mx-16 md:mx-28 lg:mx-0 bg-white dark:text-black">
