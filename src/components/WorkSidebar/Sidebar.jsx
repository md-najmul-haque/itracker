...
import InviteMemberModal from "../modalInfo/InviteMemberModal";
import Board from "../firstScreen/Board";
  ...
  return (
    <div>
      ...
      <div className="drawer drawer-mobile static ">
        ...
        <div className="drawer-side lg:mx-7 p-5 shadow">
          ...
          >
            ...
            <li className="">
              <NavLink to="/allTask" className="mb-2 p-2 pl-5 pr-5 myButton">
              All Task
              </NavLink>
            </li>
   
            <li>
              <NavLink to="/createTask" className="mb-2 p-2 pl-5 pr-5 myButton">
                Create Task
              </NavLink>
            </li>
            ...
            <div className="flex items-center justify-between bg-none m-3">
              ...
              >
                <FcAddDatabase className="text-xl  "></FcAddDatabase>
              </label>
            </div>
