...
const Reviews: FC<Props> = ({ onePersonReview }) => {
  ...
  return (
    <div>
      <div className="card card-compact w-72 h-96 bg-base-100 shadow-xl flex py-10 items-center mx-16 md:mx-28 lg:mx-0 dark:bg-black dark:text-black">
        ...
        <div className="flex flex-col items-center justify-center gap-4 dark:bg-accent dark:text-black">
