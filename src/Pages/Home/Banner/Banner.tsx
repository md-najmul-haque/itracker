    ...
    return (
        ...
        <section>
            <div className="w-full relative pb-10 px-6 xl:px-0">
                <img className="absolute bg-left-top w-full inset-0 h-full" src="https://cdn.tuk.dev/assets/templates/weCare/hero2-bg.png" alt="we care family" />
                ...
                <div className="pt-32 lg:flex  items-center relative z-10 container mx-auto">
                    ...
                    <div role="contentinfo" className="w-full lg:w-1/2 h-full">
                        ...
                        <p className="text-gray-800 font-regular mb-8">COMBINING SCIENCE WITH BEAUTY. L'Oreal Paris offerincare products is developed and rigorously tested with leading scientists. Indulge yourself in a luxurious and sensorial skincare experience. Cutting-edge innovations, proven by Science.</p>
