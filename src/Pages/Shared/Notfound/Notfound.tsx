        ...
        <div className="flex items-center justify-center bg-white">
            <div className="bg-base  flex items-center justify-center mx-4 md:w-2/3">
                <div className="flex flex-col items-center">
                    <img className="px-4 py-2 hidden md:block w-full rounded-lg" src="https://www.ursindia.com/image/404.jpg" alt="" />
                    <img className="md:hidden rounded-lg" src="https://www.ursindia.com/image/404.jpg" alt="" />
