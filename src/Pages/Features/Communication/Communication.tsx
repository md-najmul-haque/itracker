    ...
    return (
        <section className='px-12 bg-white py-10 dark:bg-black dark:text-white'>
            ...
            <div className="lg:w-3/5 mx-auto grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-16 dark:text-white">
                <div data-aos="flip-right" data-aos-easing="ease-out-cubic" data-aos-duration="3000" className="shadow-md rounded-lg px-9 hover:shadow-2xl shadow-gray-300 dark:bg-accent">
                ...
                <div data-aos="flip-right" data-aos-delay="200" data-aos-duration="1000" className="shadow-md rounded-lg px-9 hover:shadow-2xl shadow-gray-300 dark:bg-accent">
