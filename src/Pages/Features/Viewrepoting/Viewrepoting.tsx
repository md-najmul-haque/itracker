    ...
    return (
        <section className='px-12 text-center bg-white py-10 dark:bg-black dark:text-white'>
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-16 dark:text-white">
                <div data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="3000" className="shadow-md rounded-lg px-9 hover:shadow-2xl shadow-gray-300 dark:bg-accent">
                ...
                <div data-aos="zoom-in" data-aos-delay="200" data-aos-duration="1000" className="shadow-md rounded-lg px-9 hover:shadow-2xl shadow-gray-300 dark:bg-accent">
