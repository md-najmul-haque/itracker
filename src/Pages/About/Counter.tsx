...
const Counter = () => {
    ...
    return (
        <div>
            ...
            <div className='card border-solid tobBorder drop-shadow-lg  hover:bg-sky-700 hover:text-white ease-in duration-300 gap-2 pb-3 w-70 h-60 align-center justify-center text-center bg-white  shadow-xl'>
