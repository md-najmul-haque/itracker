...
const List = () => {
    ...
    const menuItem =
        <div className='flex items-center'>
            ...
            <li>
                <button className="inline-flex sm:ml-3 mt-4 sm:mt-0 items-start justify-start  focus:outline-none rounded">
    ...
    return (
        <div>
            <div className='relative'>
                <div className='navbar text-accent sticky font-semibold z-50 py-3'>
